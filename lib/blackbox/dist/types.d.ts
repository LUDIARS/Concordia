...
export type LlmFallback<I = unknown, O = unknown> = (input: I, features: FeatureMap, context: LlmContext) => Promise<LlmJudgement<O>>;
...
export type RulePatch = Partial<Pick<Rule, 'state' | 'approvals' | 'rejections' | 'shadowAgreements' | 'shadowConflicts' | 'proposals' | 'confidence' | 'priority' | 'description'>>;
/** 判断 ledger の永続化境界。 */
