...
| P1 | 114 source files lack strong static spec linkage. | `report/architecture-review-spec-domains.html.json` (generated, untracked). | Triage production files first; add `related` or explicit rule IDs only when a real contract exists. |
